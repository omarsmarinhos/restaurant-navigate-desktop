...
public class CalendarCustom extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(255, 154, 52));

        jPanel2.setBackground(new java.awt.Color(255, 154, 52));
        ...
        cmdBack.setIcon(new ImageIcon("src/main/java/icon/back.png"));
        ...
        lbMonthYear.setForeground(new java.awt.Color(255, 154, 52));
        lbMonthYear.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbMonthYear.setText("Month - Year");

        cmdNext.setIcon(new ImageIcon("src/main/java/icon/next.png"));
